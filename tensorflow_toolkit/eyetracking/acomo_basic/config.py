...
use_coord_conv = False                   # https://arxiv.org/abs/1807.03247
use_global_context = False               # globalContext as described in https://arxiv.org/pdf/1904.11492.pdf
use_self_attention = False               # for the last layer sth similar to https://arxiv.org/abs/1706.03762
use_fireblocks = False                   # squeezenet-like technique, taken from https://github.com/opencv/openvino_training_extensions/tree/develop/tensorflow_toolkit/lpr
...
model_dir = os.path.realpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'model_acomo_basic'))
